...
TRectangle {
    ...
    Item{
        ...
        Column{
            ...
            Row{
                ...
                Repeater{
                    model: [
                        {labeltxt: qsTr("播放全部"), icon:TAwesomeType.FA_play_circle_o,prominent:true},
                        {labeltxt: qsTr("收藏"), icon:TAwesomeType.FA_folder_o,prominent:false},
                        {labeltxt: qsTr("分享"), icon:TAwesomeType.FA_share_square_o,prominent:false},
                        {labeltxt: qsTr("下载全部"), icon:TAwesomeType.FA_cloud_download,prominent:false},
                    ]
    ...
    Component{
        ...
        Item{
            TLabel {
                ...
                text: qsTr("The album does not include any tracks")
            }
    ...
    Component{
        ...
        Item {
            ...
            TLabel {
                anchors.centerIn: parent
                text: qsTr("The author is lazy and doesn't write anything.")
            }
        }
    }
