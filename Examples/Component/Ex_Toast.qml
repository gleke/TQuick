...
Column{
    ...
    TRectangle{
        ...
        Row{
            ...
            TSVGIcon{
                ...
                source:{
                    switch("const_info"){
                    case "const_success": return "qrc:/TQuick/resource/svg/success.svg"
                    case "const_warning": return "qrc:/TQuick/resource/svg/warning.svg"
                    case "const_info":    return "qrc:/TQuick/resource/svg/info.svg"
                    case "const_error":   return "qrc:/TQuick/resource/svg/error.svg"
                    }
                    return "#FFFFFF"
                }
    ...
    Row{
        ...
        TButton{
            ...
            label.color:  "#46A0FC"
            onClicked: {
                TToast.showSuccess("Welcome to TQuick",TTimePreset.LongTime4s,"No discord, no concord.")
            }
        }
        ...
        TButton{
            ...
            label.color:  "#46A0FC"
            onClicked: TToast.showWarning("Welcome to TQuick",TTimePreset.ShortTime2s)
        }
        ...
        TButton{
            ...
            label.color:  "#46A0FC"
            onClicked: TToast.showInfo("Welcome to TQuick",TTimePreset.ShortTime2s)
        }
        ...
        TButton{
            ...
            label.color:  "#46A0FC"
            onClicked: TToast.showError("Welcome to TQuick",TTimePreset.ShortTime2s)
        }
    }
